...
\hainnuset{%
	% -- 中文信息                        % 论文题目↓↓↓
	title         = {基于Node.js的大学生心理健康咨询系统的设计与实现},
	studentid     = {2024021039},        % 作者学号
	author        = {门佳翔},              % 作者姓名
	class		  = {2024},
	department	  = {人工智能学院},
	major		  = {计算机科学与技术},
	supervisor    = {王振洲},              % 指导教师姓名
	% acadetitle    = {副教授},              % 导师学术头衔
	submitdate    = {二〇二六年四月}, % 论文提交日期
	corresaddr    = {海南师范大学信息科学技术学院，海口 571158},  % 通信地址
	type		  = {设计},	%文档类型：论文/设计, 因人而已，请与指导教师确认
	% -- 英文信息                        % 论文题目(英文)↓↓↓
	etitle        = {Design and Implementation of a Web-Based University Mental Health Counseling Platform},
	% eauthor       = {XXX},                % 作者姓名(英文)
	% esupervisor   = {XXX},         % 导师姓名(英文)
